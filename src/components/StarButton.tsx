...
const StarButton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <span className="flex items-center justify-center gap-1 relative z-[1] bg-black/60 backdrop-blur-md rounded-full py-1.5 px-2 2xl:py-2 2xl:px-4 2xl:pl-2 w-full border border-white/5">
        <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
          <svg
            ...
            className="opacity-80 2xl:opacity-90 animate-star-rotate w-[18px] h-[18px] 2xl:w-6 2xl:h-6"
          >
            <path
          ...
          <span
            className="rounded-full size-11 2xl:size-14 absolute opacity-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-lg animate-star-shine"
            style={{
              background: 'linear-gradient(135deg, rgb(59, 196, 242), rgb(122, 105, 249), rgb(242, 99, 120), rgb(245, 131, 63))'
            }}
          />
        </span>
        <span className="hidden 2xl:block bg-gradient-to-b ml-1.5 from-white to-white/60 bg-clip-text text-xs text-transparent group-hover:scale-105 transition transform-gpu">
